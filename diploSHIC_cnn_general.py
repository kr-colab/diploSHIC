...
import fnmatch
#if len(sys.argv)<3:
#    print("diploSHIC_cnn_general.py mode options")
#    print("\t nDims trainDir testDir heatmapFileName")
#    sys.exit()
...
parser_b.add_argument('predictFile', help='path to files to run prediction')
